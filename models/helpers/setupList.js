...
module.exports = function( list ){
  var builder = {
    ...
    register: function(){
      builder.virtualize( {
        type: function(){
          console.log("virtualize fun list.plural:", list.plural);
          return list.plural.toLocaleLowerCase();
        },
        "links.self": function(){
          var a = keystone.get( "api root" ) || "/";
          var b = list.plural.toLocaleLowerCase();
          console.log("links.selft fun this: ", this);
          console.log("builder.get( 'idField' ) is:", builder.get( 'idField' ) );
          var c = this[ 'name' ].toString();
